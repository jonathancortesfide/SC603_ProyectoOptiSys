...
const ExamenVista = () => {
  ...
  const handleSendExam = async () => {
    try {
      ...
      console.log("Enviar examen al API futuro (payload):", payload);
      // TODO: realizar llamada al API real cuando esté disponible.
      // await axiosServices.post('/api/Examenes', payload);
  ...
  const handleNext = () => {
    if (activeStep === 0 && !examen.NoPaciente) {
      setValidationError("Debe seleccionar un paciente antes de continuar.");
      return;
    }
    setValidationError("");
          ...
          <Box display="flex" justifyContent="space-between" mt={4}>
            ...
            {activeStep === steps.length - 1 ? (
              ...
              <Button
                ...
                color="primary"
                onClick={handleNext}
                disabled={activeStep === 0 && !examen.NoPaciente}
              >
                Siguiente
              </Button>
            )}
